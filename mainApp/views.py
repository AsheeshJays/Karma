...
def index(request):
    ...
    if(request.method=="POST"):
        ...
        body =  """
                    ...
                    Team:   Karma
                """
        send_mail(subject, body,"karmaonlineshop8@gmail.com",[nl.email,], fail_silently=False)
        nl.save()
    ...
    if(request.method=="POST"):
        ...
        if(check.mode=="cod"):
            ...
            body =  """
                    ...
                    http://localhost:8000
                    """
            send_mail(subject, body,"karmaonlineshop8@gmail.com",[buyer.email,], fail_silently=False)
...
def addProduct(request):
    if(request.method=="POST"):
        ...
        p.save()
        subject = "New product List on Karma Checkout Now!!!!!"
        body =  """
                    Hello!!!!
        ...
        for i in NewsLetter.objects.all():
            send_mail(subject, body,"karmaonlineshop8@gmail.com",[i.email,],fail_silently=True)
        return HttpResponseRedirect('/profile/')
...
def editProfile2(request):
    ...
    if(request.method=="POST"):
        ...
        b.save()
        return HttpResponseRedirect('/profile/')
    return render(request,"editprofile2.html",{"User":b})
    ...
    if(request.method=="POST"):
        ...
        if(flag==True):
            ...
            body =  """
                        ...
                        Team:   Karma
                    """.format(user.otp)
            send_mail(subject, body,"karmaonlineshop8@gmail.com",[user.email,], fail_silently=False)
